...
import (
	...
	"github.com/example/taranaki/config"
)
...
var RootCmd = &cobra.Command{
	Use:               "taranaki",
	Short:             "taranaki loves your data",
	Long:              "taranaki loves your data",
...
func init() {
	...
	pflags.StringVarP(
		...
		"configuration file (eg. /etc/taranaki/taranaki.yml)",
	)
